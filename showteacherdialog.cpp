    ...
    ui(new Ui::ShowTeacherDialog)
{
    ...
    qry->setQuery("Select TeacherCode as 'کد کارمندی', FirstName + ' ' + LastName as 'نام و نام خانوادگی', EducationDegree as 'مدرک تحصیلی', NationalCode as 'کد ملی', Age as 'سن' \
